...
@section('content')
  <div class="flex-container">
    <div class="columns m-t-10">
      ...
      <div class="column">
        <a href="{{route('roles.create')}}" class="button is-primary is-pulled-right"><i class="fa fa-user-plus m-r-10"></i> Buat Role Baru</a>
      </div>
    </div>
    <hr class="m-t-0">
            ...
            <article class="media">
              <div class="media-content">
                <div class="content">
                  ...
                  <h6 class="subtitle"><em>{{$role->name}}</em></h6>
                  <p>
                    {{$role->description}}
                  </p>
                </div>
