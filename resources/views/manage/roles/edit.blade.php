    ...
    <form action="{{route('roles.update', $role->id)}}" method="POST">
            ...
            <article class="media">
              <div class="media-content">
                <div class="content">
                  ...
                  <div class="field">
                    <p class="control">
                      <label for="name" class="label">Slug (tidak boleh diedit)</label>
      ...
      <div class="columns">
        <div class="column">
          ...
          <button class="button is-primary pull-right">Simpan Perubahan</button>
        </div>
      </div>
    </form>
  </div>
