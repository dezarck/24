...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
      ...
      Session::flash('success', 'Berhasi Membuat Role '. $role->display_name . ' kedalam database.');
    ...
    public function update(Request $request, $id)
    {
      ...
      Session::flash('success', 'Berhasil Merubah Role'. $role->display_name . 'Di Dalam Database');
